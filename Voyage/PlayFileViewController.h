 ...
 */
@interface PlayFileViewController : UIViewController <EZAudioFileDelegate,EZOutputDataSource,ISSpeechRecognitionDelegate>
 ...
 */
@property (nonatomic,weak) IBOutlet ZLSinusWaveView *audioPlot;
